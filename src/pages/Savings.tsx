...
const currencies: CurrencyData[] = [
  ...
  },
  {
    ...
    aerValue: 1.75,
    symbol: 'Fr',
    currentSavings: 2900.0,
  },
];

/**
 * Renders the currency icon for a given currency short name.
 */
const renderCurrencyIcon = (shortName: string): React.ReactNode => {
  switch (shortName) {
    case 'GBP':
      return (
    ...
    case 'JPY':
      return <span style={{ color: '#ffffff', fontSize: '20px', fontWeight: 600 }}>¥</span>;
    case 'CHF':
      return <span style={{ color: '#ffffff', fontSize: '16px', fontWeight: 600 }}>Fr</span>;
    default:
      return null;
  }
};
...
const Savings: React.FC = () => {
  ...
  /**
   * Handles the Continue button click to proceed to savings detail.
   */
  ...
  /**
   * Handles the Back link click to return to currency selection.
   */
  ...
  const selectedCurrency = currencies.find((c) => c.shortName === selected);

  if (step === 2 && selectedCurrency) {
    const projectedEarnings = (selectedCurrency.currentSavings * selectedCurrency.aerValue) / 100;
    ...
    return (
      <Layout>
        ...
        <div className='history'>
          <div style={{ padding: '10px' }}>
            <div className='flex flex-v-center' style={{ marginBottom: '20px' }}>
              <div className='circle-icon flex flex-v-center flex-h-center blue'>
                {renderCurrencyIcon(selectedCurrency.shortName)}
              </div>
              <div style={{ marginLeft: '20px' }}>
                <span style={{ fontSize: '1.2em', fontWeight: 500 }}>{selectedCurrency.name}</span>
                <br />
                <span style={{ color: '#999999' }}>{selectedCurrency.aer}</span>
              </div>
            </div>
            ...
            >
              <p style={{ fontSize: '0.9em', color: '#999999', marginBottom: '5px' }}>
                Current savings
              </p>
              <p style={{ fontSize: '1.5em', fontWeight: 500 }}>
                {formatAmount(selectedCurrency.currentSavings, selectedCurrency.symbol)}
              </p>
            </div>
            ...
            >
              ...
              <p style={{ fontSize: '1.1em' }}>
                In 1 year: +{formatAmount(projectedEarnings, selectedCurrency.symbol)}
              </p>
            </div>

            <div style={{ marginBottom: '15px' }}>
              <label
                htmlFor='add-savings-amount'
        ...
        <div className='add-buttons flex flex-space-between'>
          <Button type='button' text='Add funds' tabIndex={0} disabled={addAmount === ''} />
        </div>
  ...
  return (
    <Layout>
      ...
      <div className='history'>
        ...
        >
          <span style={{ color: '#ffffff', fontSize: '16px', fontWeight: 600 }}>Fr</span>
        </Currency>
      </div>
