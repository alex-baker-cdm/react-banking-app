...
@Component({
  ...
  template: `
    ...
    <div class="card-balance flex flex-v-center flex-space-between">
      <div class="flex flex-col flex-h-center flex-1 center">
        <h3>Balance</h3>
        <span>&euro; 783.45</span>
      </div>
      <div class="flex flex-col flex-h-center flex-1 center">
        <h3>Limit</h3>
        <span>&euro; 1250.00</span>
      </div>
    </div>
  `,
})
